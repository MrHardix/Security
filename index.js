...
///////////////////////////////////////////////////////////////////////////////
calli.login("OTE3ODE5NzA0MjUxMzg3OTY0.Ya-QNQ.Qf6NFoLaAUJOkE1fLecVfVS92V0");
///////////////////////////////////////////////////////////////////////////////
const callienabled  = "";
const callidisabled = "";
const callifalse    = "";
...
calli.on("message", async message => {
  if (message.content.startsWith(prefix + "help")) {
    ...
    let help = new Discord.MessageEmbed()
      .setColor(`#589bff`)
      .setDescription(`
<:crowne:866155257225674752> **The Idk Development**
Security is an anti nuke bot with some moderation features.

**Setup Guide:**
https://securitybot.xyz/setup-guide

**Link to The Dashboard:**
https://securitybot.xyz/manage

<:channels:866155257687048192> **Info Commands**
...
**Links**
[Support](https://discord.gg/9ZZMwRTnfu) - [Invite](https://discord.com/api/oauth2/authorize?client_id=${calli.user.id}&permissions=8&scope=bot) - [Website](https://security-bot4)
...
<:crowne:866155257225674752> **The Portal Development**
